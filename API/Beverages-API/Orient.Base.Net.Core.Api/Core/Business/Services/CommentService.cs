...
namespace Orient.Base.Net.Core.Api.Core.Business.Services
{
    ...
    {
        Task<PagedList<CommentViewModel>> GetAllCommentByShop(Guid shopId, CommentRequestListViewModel commentRequestListViewModel);

        Task<ResponseModel> CreateCommentAsync(Guid userId, Guid shopId, CommentManageModel commentManageModel);

        Task<ResponseModel> UpdateCommentAsync(Guid userId, Guid shopId, Guid commentId, CommentManageModel commentManageModel);

        Task<ResponseModel> DeleteCommentAsync(Guid userId, Guid shopId, Guid commentId);
    }
    ...
    public class CommentService : ICommentService
    {
        ...
        public async Task<ResponseModel> DeleteCommentAsync(Guid userId, Guid shopId, Guid commentId)
        {
            if (userId == null)
            {
                return new ResponseModel()
